        ...
        if (response.ok) {
          ...
          setTimelineDates({
            registrationDeadline:
              new Date(data.registrationDeadline).toLocaleDateString("en-US", {
                month: "long",
                day: "numeric",
                year: "numeric",
              }) + " at 11:59 PM",
            gownCollectionDeadline:
              new Date(
                data.gownCollectionDeadline || "2025-05-10T14:00:00",
            ...
            ceremonyDate:
              new Date(data.ceremonyDate).toLocaleDateString("en-US", {
                month: "long",
                day: "numeric",
                year: "numeric",
              }) + " at 10:00 AM",
            ceremonyLocation:
              data.ceremonyLocation || "GIMPA Main Campus Auditorium",
          });
        }
      } catch (error) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg shadow-sm flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Our system automatically checks your eligibility based on your
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-sm flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Complete your graduation registration form with personal details
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-sm flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Receive confirmation with all the details you need for the
                graduation day.
              </p>
            </div>
          </div>
              ...
              <div className="divide-y">
                <div className="flex items-start p-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      {timelineDates.registrationDeadline}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start p-6">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg mb-1">
                      Gown Collection Deadline
                    </h4>
                    <p className="text-gray-600">
                      {timelineDates.gownCollectionDeadline}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start p-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      {timelineDates.ceremonyDate}
                    </p>
                    <p className="text-sm text-gray-500 mt-1">
                      {timelineDates.ceremonyLocation}
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-[#1a365d] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Don't wait until the last minute. Register today to secure your spot
