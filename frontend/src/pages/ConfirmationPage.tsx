    ...
    const fetchSettings = async () => {
      try {
        console.log(
          ...
          `${API_BASE}/admin/public-settings`,
        );
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="bg-[#1a365d] text-white p-6 text-center">
            ...
            <p className="text-xl">
              Confirmation ID:{" "}
              <span className="font-mono font-medium">{confirmationId}</span>
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-800">
                    {settings
                      ? formatDate(settings.ceremonyDate)
                      : "May 15, 2025"}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start md:col-span-2">
                ...
                <div>
                  ...
                  <p className="text-gray-800">
                    {settings?.ceremonyLocation ||
                      "GIMPA Main Campus Auditorium"}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="p-6 border-b bg-yellow-50">
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li className="flex items-start">
                ...
                {settings
                  ? formatDateTime(settings.gownCollectionDeadline)
              ...
              <li className="flex items-start">
                ...
                {settings
                  ? formatDateTime(settings.gownReturnDeadline)
                  : "August 8, 2025"}
              </li>
            </ul>
          </div>
