    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Import eligible graduating students from CSV file
        </p>
      </div>
            ...
            <div className="flex">
              <div className="ml-3">
                <p className="text-sm text-blue-700">
                  <span className="font-bold">Tip:</span> Make sure your CSV
                  file is properly formatted with headers in the first row. The
                  system will validate all records before importing.
                </p>
              </div>
            </div>
          </div>
